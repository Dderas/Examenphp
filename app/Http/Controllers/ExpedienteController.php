...
class ExpedienteController extends Controller
{
    ...
    public function create()
    {
        ...
        $establecimiento= Establecimiento::pluck('nombre_establecimiento', 'id');
        $paciente= Paciente::pluck('primer_nombre', 'id');
        


        return view('expediente.create', compact('expediente', 'establecimiento','paciente'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('expediente.edit', compact('expediente','establecimiento','paciente'));
    }
